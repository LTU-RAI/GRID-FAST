...
public:
  ...
  openingDetection() {}
  ~openingDetection() {}
  point_int start() { return startPoint->position; }
  point_int end() { return endPoint->position; }
  ...
  void disconnect(bool changeStart) {
    ...
    if (point == NULL)
      return;
    vector<openingDetection *> *list = changeStart
                                           ? &point->connectedtOpeningStart
                                           : &point->connectedtOpeningEnd;
  ...
  void connect(bool changeStart, wallCell *newW) {
    ...
    vector<openingDetection *> *list = changeStart
                                           ? &newW->connectedtOpeningStart
                                           : &newW->connectedtOpeningEnd;
    list->push_back(this);
  }
  opening getOpening() {
    opening op;
